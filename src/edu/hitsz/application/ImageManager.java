...
public class ImageManager {
    ...
    static {
        try {
            ...
            ELITE_PLUS_IMAGE = ImageIO.read(new FileInputStream("src/images/elite_plus.png"));
            ...
            PROP_BULLET_PLUS_IMAGE = ImageIO.read(new FileInputStream("src/images/prop_bullet_plus.png"));
